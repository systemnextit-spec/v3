...
const AdminDeliverySettings: React.FC<AdminDeliverySettingsProps> = ({ configs, onSave, onBack }) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in w-full max-w-6xl mx-auto px-3 sm:px-4 lg:px-0">
      ...
      {/* Configuration Form */}
      {isFormVisible && (
        <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-sm overflow-hidden animate-in slide-in-from-top-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                 ...
                 <div>
                    ...
                    <div className="relative">
                        <span className="absolute left-3 sm:left-4 top-2 sm:top-2.5 lg:top-3 text-gray-500 text-sm">৳</span>
                        <input 
                        type="number" 
                        min="0"
