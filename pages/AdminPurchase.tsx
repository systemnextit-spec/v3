              ...
              return (
                <div key={product.id} className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 border-b hover:bg-gray-50">
                  ...
                  <div className="relative">
                    ...
                    {cartCount > 0 && <span className="absolute -top-1 sm:-top-2 -right-1 sm:-right-2 w-4 h-4 sm:w-5 sm:h-5 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center">{cartCount}</span>}
                  </div>
                </div>
              );
            })}
