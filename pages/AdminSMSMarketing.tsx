        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              ...
              {selectedContacts.length === 0 ? <div className="flex items-center justify-center py-6 border-2 border-dashed border-gray-200 rounded-lg"><p className="text-sm text-gray-400">Select contacts from the list</p></div> :
