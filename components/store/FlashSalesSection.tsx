    ...
    >
      ...
      <div className="relative aspect-square bg-gray-50 overflow-hidden">
        ...
        <button 
          ...
          className="absolute top-1 right-1 sm:top-2 sm:right-2 z-10 w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-white/90 shadow-sm flex items-center justify-center hover:scale-110 transition-transform"
        >
        ...
        {discountPercent && discountPercent > 0 && (
          <span className="absolute top-1 left-1 sm:top-2 sm:left-2 bg-red-500 text-white text-[8px] sm:text-[10px] font-bold px-1 sm:px-2 py-0.5 sm:py-1 rounded sm:rounded-md shadow-sm">
            -{discountPercent}%
          </span>
        )}
