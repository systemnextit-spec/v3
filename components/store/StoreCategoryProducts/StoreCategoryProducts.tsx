        ...
        <div className="flex-1 min-w-0">
          ...
          {sorted.length > 0 ? (
            ...
            <div className="py-16 text-center">
              ...
              {(selectedBrand || selectedTag) && <button onClick={clearFilters} className="mt-4 px-6 py-2 bg-theme-primary text-white rounded-lg text-sm font-semibold hover:opacity-90 transition">Clear Filters</button>}
            </div>
          )}
        </div>
      </div></div></div>
