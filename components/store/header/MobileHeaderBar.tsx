...
const MobileHeaderStyle2: React.FC<MobileHeaderBarProps> = ({
  ...
  <header className="md:hidden bg-white px-3 py-2 border-b border-gray-200 top-0 z-50">
...
const MobileHeaderStyle3: React.FC<MobileHeaderBarProps> = ({
  ...
  <header className="md:hidden bg-gradient-theme-via px-3 py-2.5 top-0 z-50 shadow-lg">
    <div className="flex items-center justify-between gap-3">
      <div className="flex items-center gap-2">
...
const MobileHeaderStyle4: React.FC<MobileHeaderBarProps> = ({
  ...
  <header className="md:hidden bg-white border-b border-gray-200 top-0 z-50">
...
const MobileHeaderStyle5: React.FC<MobileHeaderBarProps> = ({
  ...
  <header className="md:hidden bg-gray-900 px-3 py-2.5 top-0 z-50 shadow-lg">
    <div className="flex items-center justify-between gap-3">
      <div className="flex items-center gap-2">
