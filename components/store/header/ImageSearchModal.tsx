          ...
          {!isCameraMode && !imagePreview && !result && (
            <div className="grid grid-cols-2 gap-4 mb-4">
              <button
                ...
                className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-theme-primary hover:bg-theme-primary/5 transition-all group"
              >
