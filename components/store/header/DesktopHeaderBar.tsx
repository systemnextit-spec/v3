  ...
  return (
    <header className="hidden md:block sticky top-0 z-50">
      <div className="bg-gradient-theme-via shadow-lg">
        <div className="max-w-[1408px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between gap-6">
  ...
  return (
    <header className="hidden md:block sticky top-0 z-50">
      <div className="bg-gray-900 text-white/80 text-xs">
        <div className="max-w-[1408px] mx-auto px-6 py-1.5 flex items-center justify-between">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-[1408px] mx-auto px-6 py-3 flex items-center gap-8">
          <button type="button" className="flex-shrink-0" onClick={onHomeClick}>
