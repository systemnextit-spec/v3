  ...
  return (
    <div className="bg-white min-h-screen font-['Poppins']">
      <div className="px-5 py-5">
        {/* Header */}
        <h1 className="text-[22px] font-bold text-[#023337] tracking-[0.11px] font-['Lato'] mb-5">
          Inventory
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-5">
          ...
          <div className="bg-[#f9f9f9] rounded-lg p-4 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              ...
              <div>
                <p className="text-[24px] font-medium text-black">{inventoryStats.totalProducts}</p>
          ...
          <div className="bg-[#f9f9f9] rounded-lg p-4 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              ...
              <div>
                <p className="text-[24px] font-medium text-black">{inventoryStats.totalUnits}</p>
          ...
          <div className="bg-[#f9f9f9] rounded-lg p-4 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              ...
              <div>
                <p className="text-[24px] font-medium text-black">{inventoryStats.lowStockCount}</p>
          ...
          <div className="bg-[#f9f9f9] rounded-lg p-4 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              ...
              <div>
                <p className="text-[24px] font-medium text-black">৳ {inventoryStats.inventoryValue.toLocaleString('en-IN')}</p>
          ...
          <div className="bg-[#f9f9f9] rounded-lg p-4 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              ...
              <div>
                <p className="text-[24px] font-medium text-black">৳ {inventoryStats.inventorySaleValue.toLocaleString('en-IN')}</p>
