...
const CountdownTimer: React.FC<{ endDate: string; lang: Language }> = ({ endDate, lang }) => {
  ...
  if (isExpired) {
    return (
      <div className="bg-gradient-to-r from-red-500 to-rose-500 text-white py-4 px-6 rounded-2xl text-center shadow-lg">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2 sm:space-y-3">
        ...
        <div className="relative">
          <MapPin className={`absolute left-3 top-2.5 sm:top-3 ${isFieldError('address') ? 'text-red-400' : 'text-gray-400'}`} size={18} />
      ...
      <div className="max-w-6xl mx-auto px-2.5 sm:px-4 py-4 sm:py-8 lg:py-10">
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 order-1 lg:order-2" ref={orderFormRef}>
            <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-6 shadow-lg border border-gray-100 lg:sticky lg:top-4">
