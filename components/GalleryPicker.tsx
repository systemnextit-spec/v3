            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex gap-2">
                ...
                <div className="relative">
                  ...
                  {showSortMenu && (
                    <div className="absolute right-0 top-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl py-2 min-w-[160px] z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                {filteredImages.map((img, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {multiple && isSelected && (
                        <div className="absolute top-3 left-3 bg-white text-purple-600 text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center shadow-lg">
